...
class tempCalculator(EasyFrame):
    def __init__(self):
        ...
        # This code is for users to press enter/return for calculation to trigger
        self.fahrenheit.bind("<Return>", lambda event: self.calculateF())
        self.celcius.bind("<Return>", lambda event: self.calculateC())
